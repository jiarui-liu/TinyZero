...
export DATA_DIR=/home/jiaruil5/social_reasoning_rl/data/countdown
export EXPERIMENT_NAME=countdown-tinyzero
export ROLLOUT_TP_SIZE=2
export VLLM_ATTENTION_BACKEND=XFORMERS
export SAVE_DIR=/compute/babel-2-29/jiaruil5/social_reasoning/tinyzero/countdown_distilled_1.5b
